...
export const translations: Record<string, { en: string; ta: string }> = {
  ...
  'auth.signup': { en: 'Sign up', ta: 'பதிவு செய்க' },
  'auth.signin': { en: 'Sign in', ta: 'உள்நுழைக' },
  'auth.loginTitle': { en: 'Welcome back', ta: 'மீண்டும் வரவேற்கிறோம்' },
  'auth.registerTitle': { en: 'Create account', ta: 'கணக்கை உருவாக்கவும்' },
  'auth.loginSub': { en: 'Sign in to manage your bus device', ta: 'உங்கள் பேருந்து சாதனத்தை நிர்வகிக்க உள்நுழைக' },
  'auth.registerSub': { en: 'Register to link your ESP32 device', ta: 'உங்கள் ESP32 சாதனத்தை இணைக்க பதிவு செய்க' },
  'auth.error': { en: 'Invalid email or password', ta: 'தவறான மின்னஞ்சல் அல்லது கடவுச்சொல்' },
  'auth.registerError': { en: 'Registration failed', ta: 'பதிவு தோல்வியடைந்தது' },
  'auth.loggedInAs': { en: 'Logged in as', ta: 'இவ்வாறு உள்நுழைந்துள்ளீர்கள்' },
  'auth.deviceId': { en: 'Device ID', ta: 'சாதன ஐடி' },
  'auth.linkDevice': { en: 'Link ESP32 Device', ta: 'ESP32 சாதனத்தை இணைக்கவும்' },
